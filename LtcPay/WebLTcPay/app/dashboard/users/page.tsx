...
const ROLES_PERMISSIONS = [
  { r: "Root admin", n: 1, p: ["â", "â", "â", "â", "â", "â"] },
  { r: "Operations lead", n: 1, p: ["â", "â", "â", "â", "—", "—"] },
  { r: "Compliance / KYC", n: 1, p: ["â", "â", "â", "—", "—", "—"] },
  { r: "Finance manager", n: 1, p: ["â", "â", "—", "â", "—", "—"] },
  { r: "Engineer", n: 1, p: ["â", "â", "—", "—", "—", "—"] },
  { r: "Support", n: 1, p: ["â", "—", "—", "—", "—", "—"] },
  { r: "Analyst", n: 1, p: ["â", "—", "—", "—", "—", "—"] },
  { r: "Auditor (read-only)", n: 1, p: ["â", "—", "—", "—", "—", "—"] },
];
      ...
      <div className="card" style={{ padding: 0, overflow: "hidden", marginBottom: 12 }}>
        <div className="tbl">
          <div className="row head" style={{ gridTemplateColumns: "auto 1.4fr 1fr 1fr 0.5fr 0.7fr 0.8fr 24px" }}>
            ...
            <span><T fr="Ãquipe" en="Team" /></span>
            <span>MFA</span>
          ...
          <div className="tbl">
            ...
            {ROLES_PERMISSIONS.map((r, i) => (
              <div key={i} className="row" style={{ gridTemplateColumns: "1.4fr 0.5fr 0.8fr 0.8fr 0.8fr 0.8fr 0.8fr 0.6fr" }}>
                ...
                {r.p.map((p, j) => (
                  <div key={j} className="mono" style={{ fontSize: 12, color: p === "â" ? "var(--success)" : "var(--muted-2)" }}>{p}</div>
                ))}
              </div>
            ))}
          </div>
