            ...
            <div className="card">
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 14, padding: 14, border: "1px solid var(--ink)", borderRadius: 10, background: "oklch(0.97 0.01 260)" }}>
                  ...
                  <div style={{ flex: 1 }}>
                    <strong style={{ fontWeight: 500, display: "block" }}>Afriland First Bank · â¢â¢â¢â¢4912</strong>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 14, padding: 14, border: "1px solid var(--line)", borderRadius: 10 }}>
                  ...
                  <div style={{ flex: 1 }}>
                    <strong style={{ fontWeight: 500, display: "block" }}>Orange Money · â¢â¢â¢ 56</strong>
                    <span style={{ fontSize: 12, color: "var(--muted)" }}>
              ...
              <div style={{ marginTop: 32 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
                  {[
                    ...
                    { v: "manual", labelFr: "Manuel", labelEn: "Manual", subFr: "Ã la demande", subEn: "On demand" },
                  ].map(o => (
                    <div
                      key={o.v}
