...
function GetPaymentSection() {
  ...
  -H "X-API-Secret: ltcpay_secret_..."`}</CodeBlock>
      ...
      <FieldTable fields={[
        ...
        { name: "payment_mode", type: "string", desc: "SDK, DIRECT_API ou STRIPE." },
        { name: "provider", type: "string|null", desc: "Fournisseur ayant traité le paiement : TOUCHPAY, ACCOUNTPE (Mobile Money) ou STRIPE (carte). Le choix du fournisseur mobile est automatique par pays, avec bascule sur un fournisseur secondaire en cas de panne — transparent pour votre intégration." },
