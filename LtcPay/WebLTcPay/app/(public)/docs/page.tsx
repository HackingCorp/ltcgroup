...
function GetPaymentSection() {
  ...
  -H "X-API-Secret: ltcpay_secret_..."`}</CodeBlock>
      ...
      <FieldTable fields={[
        ...
        { name: "provider", type: "string|null", desc: "Fournisseur ayant traité le paiement : TOUCHPAY ou ACCOUNTPE (Mobile Money), STRIPE ou ENKAP (carte). Le choix du fournisseur est automatique par pays, avec bascule sur un fournisseur secondaire en cas de panne — transparent pour votre intégration." },
